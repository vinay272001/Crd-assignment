...
// ExamplecrdV1Client is used to interact with features provided by the examplecrd.k8s.io group.
type ExamplecrdV1Client struct {
	restClient rest.Interface
}

func (c *ExamplecrdV1Client) ExampleCrds(namespace string) ExampleCrdInterface {
	return newExampleCrds(c, namespace)
}
