...
import (
	...
	phoenixcomv1alpha1 "github.com/vinay272001/Crd-assignment/pkg/apis/phoenix.com/v1alpha1"
	...
	v1alpha1 "github.com/vinay272001/Crd-assignment/pkg/client/listers/phoenix.com/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.PhoenixV1alpha1().PipelineRuns(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PhoenixV1alpha1().PipelineRuns(namespace).Watch(context.TODO(), options)
			},
		},
		&phoenixcomv1alpha1.PipelineRun{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *pipelineRunInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&phoenixcomv1alpha1.PipelineRun{}, f.defaultInformer)
}
