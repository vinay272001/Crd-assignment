	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.PhoenixV1alpha1().TaskRuns(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PhoenixV1alpha1().TaskRuns(namespace).Watch(context.TODO(), options)
			},
		},
		&phoenixcomv1alpha1.TaskRun{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *taskRunInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&phoenixcomv1alpha1.TaskRun{}, f.defaultInformer)
}
